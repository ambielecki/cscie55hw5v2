...
public class Account {
    ...
    public Account(String firstName, String lastName, String email) throws AccountException {
        if (firstName.isEmpty()) {
            throw new AccountException("Invalid parameter: empty First Name");
        }
        if (lastName.isEmpty()) {
            throw new AccountException("Invalid parameter: empty Last Name");
        }
        if (email.isEmpty()) {
            throw new AccountException("Invalid parameter: empty email");
        }
