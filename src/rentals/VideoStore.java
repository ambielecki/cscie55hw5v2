...
public class VideoStore {
    ...
    public void createAccount(String firstName, String lastName, String email) throws AccountException {
        ...
        if (dupEmail) {
            throw new AccountException("This email has already been used");
        } else {
